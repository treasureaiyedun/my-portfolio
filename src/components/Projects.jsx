  ...
  const projects = [
    {
      ...
      image: AtomicLite,
      title: "Atomic Lite",
      description: "A minimalistic, clean UI demo inspired by the Atomic Lite theme by GiantFocal, designed to showcase layout, typography, and aesthetic consistency.",
      stack: ["HTML", "CSS"],
    ...
    },
    {
      ...
      image: TechWorld,
      title: "Tech World",
      description: "A demo tech-themed UI built to showcase my frontend design skills, featuring a clean layout, smooth interactions, and a modern aesthetic.",
    ...
    },
    {
      ...
      image: Bumbu,
      title: "Bumbu App",
      description: "A sleek, responsive website built for a car trading app, showcasing listings and app features with a clean, modern UI.",
      stack: ["ReactJS", "TailwindCSS"],
  ...
  return (
    ...
    >
      <div className="text-center mb-8 border-t border-gray-300 dark:border-gray-600 lg:pt-20">
        <h2 className="text-3xl font-semibold dark:text-white mt-8 mb-3 font-heading">Featured Projects 👩🏽‍🍳</h2>
